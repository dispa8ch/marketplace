        ...
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#757575] mt-1">
              Add and manage staff who can access your dashboard
            </p>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {[
                  ...
                  {
                    name: "Stefan Carvalho",
                    role: "Admin",
                    email: "stefancarvalho@gmail.com",
                    status: "Active",
                  },
                  {
                    name: "Garry Foresters",
                    role: "Admin",
                    email: "garryforesters@gmail.com",
                    status: "Active",
                  },
                  {
                    name: "Kimmy Hendrics",
                  ...
                  },
                  {
                    name: "James Dematrio",
                    role: "Admin",
                    email: "jamesdematrio@gmail.com",
                    status: "Active",
                  },
                  {
                    name: "Alavera Deturo",
                    role: "Analyst",
                    email: "alaveradeturo@gmail.com",
                    status: "Inactive",
                  },
                  {
                    name: "Damian Fallon",
                    role: "Analyst",
                    email: "damianfallon@gmail.com",
                    status: "Active",
                  },
                ].map((member, index) => (
                  <tr
                  ...
                  >
                    <td className="py-4 px-4 text-sm font-medium text-[#171717]">
                      {member.name}
                    </td>
