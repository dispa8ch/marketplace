...
export default function VerifyPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="hidden lg:flex flex-col relative bg-[#2A402D] text-[#EBE1DC] p-12 overflow-hidden order-2">
        <div className="absolute inset-0 z-0 opacity-40">
          <Image src="/placeholder.svg?key=verify" alt="Security pattern" fill className="object-cover" priority />
        </div>
      ...
      <div className="flex flex-col justify-center items-center p-6 lg:p-24 relative order-1">
        <div className="w-full max-w-[400px] space-y-12">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl font-serif text-primary">Check your email</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-6">
              <Label className="text-center w-full block">ENTER VERIFICATION CODE</Label>
              <div className="flex justify-between gap-2">
                {otp.map((digit, index) => (
                  <Input
                    ...
                    className="w-12 h-16 text-center text-2xl font-serif border-b-2 border-primary/20 focus-visible:border-primary focus-visible:ring-0 rounded-none bg-transparent px-0"
                  />
                ))}
              </div>
            </div>
