...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="hidden lg:flex flex-col relative bg-[#D4C5BE] text-[#2A402D] p-12 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-30">
          <Image src="/placeholder.svg?key=forgot-pass" alt="Abstract lines" fill className="object-cover" priority />
        </div>
      ...
      <div className="flex flex-col justify-center items-center p-6 lg:p-24 relative">
        <div className="w-full max-w-[400px] space-y-12">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl font-serif text-primary">Forgot Password?</h2>
