...
import { CustomerDetailsModal } from "@/components/admin/modals/customer-details-modal"
...
export default function AdminCustomersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <CustomerDetailsModal open={isDetailsOpen} onOpenChange={setIsDetailsOpen} customer={selectedCustomer} />
    </div>
  )
}
