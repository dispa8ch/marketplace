      ...
      <div className="p-4 bg-green-50 rounded-md border"> 
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground">Lat: {coords.lat.toFixed(4)}, Lng: {coords.lng.toFixed(4)}</div>
          </div>
        </div>
      </div>
    )
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-muted-foreground">Allow location for accurate delivery estimates.</div>
